...
impl JiraDatabase {
    ...
    pub fn create_epic(&self, epic: Epic) -> Result<u32> {
        ...
        let new_epic_id = db_state.last_item_id + 1;

        // Bump up last_item_id.
        db_state.last_item_id = new_epic_id;
    ...
    pub fn create_story(&self, story: Story, epic_id: u32) -> Result<u32> {
        ...
        let new_story_id = db_state.last_item_id + 1;

        // Bump up last_item_id.
        db_state.last_item_id = new_story_id;

        // Insert the new story.
        db_state.stories.insert(new_story_id, story);

        // Find the epic with this epic_id, and add the new_story_id under this epic.
        // Return an error if this epic could not be found.
        db_state
            .epics
            .get_mut(&epic_id)
    ...
    pub fn delete_epic(&self, epic_id: u32) -> Result<()> {
        ...
        // Find the epic with this epic_id, and delete all stories under this epic.
        // Return an error if this epic could not be found.
    ...
    pub fn delete_story(&self, epic_id: u32, story_id: u32) -> Result<()> {
        ...
        // Check if the parent epic with this epic_id exists.
        // Return an error if this epic could not be found.
        let epic = db_state
            .epics
            .get_mut(&epic_id)
        ...
        // Check if this story_id exists under the parent epic.
        // Return an error if an entry could not be found.
        ...
        // Delete the story_id under the parent epic.
    ...
    pub fn update_epic_status(&self, epic_id: u32, status: Status) -> Result<()> {
        ...
        // Find the epic with this epic_id and update its status.
        // Return an error if this epic could not be found.
        db_state
            .epics
            .get_mut(&epic_id)
    ...
    pub fn update_story_status(&self, story_id: u32, status: Status) -> Result<()> {
        ...
        // Find the story with this story_id and update its status.
        // Return an error if this story could not be found.
        db_state
            .stories
            .get_mut(&story_id)
